...
import httpx  # Importing httpx for API request
...
async def song_commad_private(client, message: Message, _):
    ...
    try:
        (title, duration_min, duration_sec, thumbnail, vidid,) = await Platform.youtube.details(query)
    except Exception:
            ...
            if response.status_code == 200:
                ...
                if download_url:
                    ...
                    med = InputMediaAudio(
                        ...
                        title=title,
                        performer=data.get("artist", "Unknown Artist"),
                    )
                    ...
                    return await mystic.edit_text(_["song_9"].format("No download link"))
            else:
